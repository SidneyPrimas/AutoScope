...
from tensorflow.python.keras.layers import Conv2D, MaxPooling2D, Input, Dense, Flatten, GlobalAveragePooling2D, Dropout, BatchNormalization, Concatenate # Import custom layers. 
...
def base_model_with_pos(input_shape, base_weights, classes, reg_lambda=0.001): 
	"""
	Configuration: data_format => channel_last
	Args: 
	input_shape: shape of image, including the channel. 
