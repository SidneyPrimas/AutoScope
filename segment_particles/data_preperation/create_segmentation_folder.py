...
+ The script places all images into the training folders (annotations and images). It's up to the user to seperate out training and validation files correctly. 
...
""" Crop Parameters """
crop_increment = 240 # How much the crop window is shifted for each crop 
