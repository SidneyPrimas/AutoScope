...
class IrisConfig_Base:
	...
	root_dir =  "./classify_particles_keras/data/image_data/20171202_input_data/"
	custom_weight_file_input = "./classify_particles_keras/data/model_storage/20171202_experiments/20171201_vgg16_customTL_dev.h5" #Set to none to disable
	tl_model_file = "./classify_particles_keras/data/model_storage/20171202_experiments/20171201_vgg16_customTL_dev.h5"
	ft_model_file = "./classify_particles_keras/data/model_storage/20171202_experiments/20171201_vgg16_customFT_dev.h5"
	log_dir = "./classify_particles_keras/data/log/20171202_irisClassification/"
	target_size = (56, 56)
	batch_size = 120
	num_epochs = 50
	channels = 3
	...
	batches_per_epoch_train = 50 # Batches for each training session. If None, set so that every image is trained. 
	batches_per_epoch_val = 3 # Batches for each validation session. If None, set so that every image is trained. 
	...
	log_name = "TF_logger"
	log_file_name = "2017123_endTest.log" #"experiment.log" #If None, then name based on datetime.
