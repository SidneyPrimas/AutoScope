...
class IrisConfig_Base:
	...
	tl_model_file = "./class_particles/data/model_storage/20171202_experiments/20171201_vgg16_customTL_dev.h5"
	ft_model_file = "./class_particles/data/model_storage/20171202_experiments/20171201_vgg16_customFT_dev.h5"
	...
	batches_per_epoch_train = 10 # Batches for each training session. If None, set so that every image is trained. 
