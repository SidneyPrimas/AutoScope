...
def main():
	...
	params.dropout = 0.5
	params.target_dim = 52
	params.class_size = len(np.unique(params.directory_map.values()))

	params.data_directory = "./data/reversed_data/"
	...
	if (LOAD_FILTERS): 
		saver_filters.restore(sess, "./data/saved_models/201612_class_models/download_in_201612/particle_model_filters_2times2Layers_from_154_v1")
		print >> params.log,("Restored Filters from: %s")%("./data/saved_models/201612_class_models/download_in_201612/particle_model_filters_2times2Layers_from_154_v1")
