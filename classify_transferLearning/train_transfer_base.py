...
# Import Model
from vgg_model_tf import VGG16_with_custom_FC_average
...
BATCH_SIZE = 32
EPOCH = 1
TRAIN_DIR = "./data_storage/random_datasets/cat_dog_data/train_dir"
VAL_DIR =  "./data_storage/random_datasets/cat_dog_data/val_dir"
CLASSES = len(glob.glob(TRAIN_DIR + "/*"))
INPUT_WEIGHTS_FILE = "./model_storage/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"
OUTPUT_MODEL_FILE = "./classify_transferLearning/data/model_storage/cat_dog_data/20171125_vgg16_customTF_dev.h5"
...
def train():
	...
	# Build model
	model = VGG16_with_custom_FC_average(input_shape = IMAGE_SHAPE, base_weights = INPUT_WEIGHTS_FILE, classes=CLASSES)
