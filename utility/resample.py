...
# Note: Make sure resolutions are given in float (otherwise they are assumed to be integers)
debug_flag = 0
original_resolution = 1.36 # um/pixel
target_resolution = 10.0 #um/pixel
